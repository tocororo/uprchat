...
# from .schemas import general_schema
...
async def start_general_recollection(start_url):
    ...
    run_config = CrawlerRunConfig(extraction_strategy=collection_strategy,
...
asyncio.run(start_general_recollection("https://www.upr.edu.cu"))
